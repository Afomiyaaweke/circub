#!/usr/bin/env python3
"""Task 72 local E2E: 'Plan my budget' as a direct camera-search entry (v55).
...
def main():
    ...
    with sync_playwright() as p:
        ...
        page.screenshot(path=f"{SHOTS}/task72-local-panel-budget.png")
        ...
        page.screenshot(path=f"{SHOTS}/task72-local-panel-verdict.png")
        ...
        if toggle.count() > 0:
            ...
            page.screenshot(path=f"{SHOTS}/task72-local-dark-budget.png")
        ...
        page_m.screenshot(path=f"{SHOTS}/task72-local-mobile-budget.png")
        page_m.close()
        browser.close()
