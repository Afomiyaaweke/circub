...
export const DEMO_POSTS: DemoPost[] = [
  { u: 'kenji_tanaka', c: 'Camped at the crater rim last night - look how the moon looks at the camping site. Pitched the tent at 6pm, woke up to this and a million stars. Best free bed in Ethiopia.', img: '/seed-images/moon-camping.jpg' },
  { u: 'selam_bekele', c: 'Roasted my first batch of Yirgacheffe on the skillet this morning. Chocolate and citrus notes - the whole house smells like a cafe. Next batch I am trying Sidama.', img: '/seed-images/coffee-beans.jpg' },
  { u: 'meron_tadesse', c: 'New review: the shiro at that little spot behind Kadisco Hospital is unreal. 120 birr, comes with fresh injera and sides. Go before 1pm, it fills up fast.', img: '/seed-images/injera-platter.jpg' },
  { u: 'selam_bekele', c: 'Coffee ceremony at my place this Sunday, 3pm. Roasting on the pan, popcorn on the side, everyone welcome - bring a friend.', img: '/seed-images/coffee-ceremony.jpg' },
  { u: 'meron_tadesse', c: 'PSA: the fresh juice guys near Bole Medhanialem now do avocado-sprite mixes for 90 birr. Dangerous levels of good.', img: '/seed-images/avocado-juice.jpg' },
  { u: 'kidist_fikru', c: 'Honey bread is out of the oven. CMC pickup until 6pm, delivery for orders above 800 birr.', img: '/seed-images/honey-bread.jpg' },
  ...
  { u: 'dawit_tesfaye', c: 'Hidden gem: Zengena Lake near Injibara. No resorts, no noise, just a perfect round crater lake and fish tibs at the village. Weekend trip from Addis is doable.', img: '/seed-images/crater-lake.jpg' },
  ...
  { u: 'samuel_k', c: 'Merkato at 7am hits different. Light coming through the fabric stalls, everyone bargaining before breakfast. Shot a full roll.', img: '/seed-images/merkato-morning.jpg' },
  { u: 'hanna_girma', c: 'Finished a full habesha kemis in mint green with modern shoulders. The tilet weave took three weeks but worth every day. Ready for pickup Monday.', img: '/seed-images/habesha-dress.jpg' },
  ...
  { u: 'tigist_n', c: 'Merkato price check: white cotton tilet per meter is up 15% since last month. Buy what you need early before the holidays push it higher.', img: '/seed-images/textiles.jpg' },
  ...
  { u: 'nati_t', c: 'Court review: the Ayat 45 meter public court got a new surface. Free before 9am, 50 birr per person after. Sneaker meetup there Sunday.', img: '/seed-images/sneakers.jpg' },
  ...
  { u: 'addis_fresh', c: "Today's market basket: avocados 25 birr each, papaya 60/kg, fresh milk 95/liter. Order by 9pm for morning delivery.", img: '/seed-images/fresh-produce.jpg' },
  ...
  { u: 'samuel_k', c: 'Golden hour at Entoto is 6:10pm sharp this week. The eucalyptus backlights like gold thread. Free location tip for the photographers out there.', img: '/seed-images/entoto-view.jpg' },
  ...
  { u: 'addis_fresh', c: 'New stock: Sidama honey, 700ml jars, 1,450 birr. From the woreda cooperative straight to your table. Limited this week.', img: '/seed-images/local-honey.jpg' },
  ...
  { u: 'kenji_tanaka', c: 'The minibus taxi system terrified me on day one. Today I hand exact change and yell my destination like a local. Small victories. Also learned the hard way: rush hour is a contact sport.', img: '/seed-images/minibus-taxi.jpg' },
